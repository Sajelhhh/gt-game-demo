...
**YOU ARE IN: `eiragame/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/eiragame/` (rig root) or other directories
...
**Your mail address:** `eiragame/polecats/obsidian`
**Your rig:** eiragame
**Your Witness:** `eiragame/witness`
...
| Ask Witness for help | `gt mail send eiragame/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`eiragame/witness`) when:
...
```bash
gt mail send eiragame/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
